...
#
# For example, for "5" as the value of my_var,
# get_integer would return the integer 5.
#
# If the value of my_var is the string
# "Boggle.", then get_integer would

# return a string with the value "Cannot convert!"
