...
go_exam = exam
go_sunny = not exam and sunny and ((sunblock and morning_classes) or night_classes)
go_raining = not exam and raining and rain_jacket
go_snowing = (
    not exam
    and snowing
    and ((fluffy_coat and (friends_are_going or snow_boots)) or really_want_to_go)
)

print(
    "True or false: I should go to class:",
    go_exam or go_sunny or go_raining or go_snowing,
)
