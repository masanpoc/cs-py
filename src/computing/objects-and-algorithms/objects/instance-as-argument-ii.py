...
def get_owner_string(pet_instance):
    return f"{pet_instance.name.first} {pet_instance.name.last}'s owner is {pet_instance.owner.name.first} {pet_instance.owner.name.last}."
