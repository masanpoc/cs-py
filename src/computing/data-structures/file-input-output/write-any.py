...
write_weird_file(
    "output-test.txt",
    ["Hmm, I bet this text will disappear.", "I wonder where it will go?"],
)
write_weird_file("output-test.txt", ["Wait, where'd the other text go?", "It's gone!"])
write_weird_file(
    "output-test.txt", [2, 1, 3], mode="a", sort_first=True, reverse_first=True
)
