...
def wish_list(wish_list, item_name, item_cost, budget):
    if item_name in wish_list and budget >= item_cost:
        return f"You should buy a {item_name}!"
    elif item_name in wish_list and budget < item_cost:
        return f"You should save up for a {item_name}!"
    elif item_name not in wish_list:
        return f"You probably don't want to buy a {item_name}."
